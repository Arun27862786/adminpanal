...
<label class="uk-form-label" for="form-horizontal-text">Choose Department:</label></td><td>
   ...
   <?php foreach($get_all_departments as $dp) { ?> 
    ...
    <div class="uk-margin">
        ...
        <div class="uk-form-controls">          
            <input class="uk-input " type="text" name="question" placeholder="Enter Question"> 
        </div>
    </div> 
    ...
    <div class="uk-margin">
     ...
     <button class="uk-button uk-button-success uk-border-rounded uk-width-1-1@m" type="submit" name="add_knowledge">Submit</button>
