...
<h3>Project Name:<? echo"  ". $project['project_name']; ?></h3>
...
elseif($project['status']==1){ $status="Archived"; } if($status=="Active"){?>
    ...
    <div class="uk-inline">
        ...
        <div uk-dropdown="mode: click; boundary: ! .uk-button-group; boundary-align: true;">
            <ul class="uk-nav uk-dropdown-nav">   
             <li class="uk-nav-header"><a href="<?php echo $link->link('view_project',backend,'?archive_id='.$project['id']);?>" onclick="return confirm('Are you sure to Archived ')"> Archived Project</a></li>

             <li class="uk-nav-header"><a href="<?php echo $link->link('view_project',backend,'?delete_id='.$project['id']);?>" onclick="return confirm('Are you sure to Delete')" >Delete Project</a></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="uk-inline">
        ...
        <div uk-dropdown="mode: click; boundary: ! .uk-button-group; boundary-align: true;">
            <ul class="uk-nav uk-dropdown-nav">   
             <li class="uk-nav-header"><a href="<?php echo $link->link('view_project',backend,'?restore_id='.$project['id']);?>" onclick="return confirm('Are you sure to Restore ')"> Restore Project</a></li>
