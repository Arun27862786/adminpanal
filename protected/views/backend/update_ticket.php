 ...
 <div class="uk-card uk-card-default uk-padding-small">
  <h3>Reply</h3>
 <h4><?php echo "Subject: ".$getTicket_info['subject'];?></h4>
...
<?php } if(!$getreplys['user_id']==0) { 
 ...
 <input class="uk-input" id="form-horizontal-text" name="ticket_id" type="hidden"  value="<?php echo $getTicket_info['id'];?>"> 
    ...
    <div class="uk-margin">
        ...
        <div class="uk-form-controls">
            <select class="uk-select" id="form-horizontal-select"  name="status">
             <option><?php echo $getTicket_info['status'];?></option>
    ...
    <div class="uk-margin">
        ...
        <div class="uk-form-controls">
            ...
            <option><?php echo $getTicket_info['priority'];?></option>
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
       <textarea class="uk-textarea"  type="text"  rows="6" cols="50" name="description" placeholder="Reply"></textarea>
        </div>
    </div>
