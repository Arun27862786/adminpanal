...
<progress id="js-progressbar2" class="uk-progress" value="0" max="100" hidden></progress>
  ...
  <hr>
  <div class="uk-margin">
        <button type="submit" class="uk-button uk-button-success uk-border-rounded uk-width-1-1@m" name="submit_settings" ><span uk-icon="icon:file-edit"></span>Update</button> 
    </div>  
   </form>
   </div>
   </div>
