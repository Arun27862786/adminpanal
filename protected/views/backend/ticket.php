 ...
 <div class="uk-card uk-card-default uk-padding-small">
    <div uk-grid> 
            <div class="uk-width-expand@m"> 
             <legend class="uk-legend"> All Tickets</legend>
      </div>
     <div class="uk-width-auto@m">
        <a  href="<?php echo $link->link('addticket',backend);?>" class="uk-button uk-button-primary uk-border-rounded"><span uk-icon="icon: pencil"></span> Add Ticket </a>
     </div>
 </div>
