...
$all_supply_item_tax=$db->run("select* from `tax` where `what_trans_is_used`='supply'")->fetchall();
//print_r($all_supply_item_tax);
...
<header class="pageheader">
                        <h3><i class="fa fa-user"></i> Estimates </h3>
                        ...
                        <div class="panel">
                                    ...
                                    <div class="panel-heading ui-sortable-handle">
                                        <div class="panel-control">
                                            <div class="btn-group">
                                                 <a href="<?php echo $link->link('selling_estimates',user);?>" class="btn btn-info pull-right"><i class="fa fa-arrow-left"></i> Back</a>
                                                 <a href="<?php echo $link->link('add_selling_estimate',user);?>" class="btn btn-danger pull-right"><i class="fa fa-times"></i> Cancel</a>
                                                 <button class="btn btn-custom pull-right" type="submit" name="submit"><i class="fa fa-save"></i> Save</button>
                                                 </div>
                                        </div>
                                        <h3 class="panel-title">Add Quotation</h3>
                                    </div>
                                    <!--Panel body-->
...
?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       ...
                                       <?php echo $customer_row['postal_address_suburb'].' '.$customer_row['postal_address_state'].' '.$customer_row['postal_address_postcode'];?>
                                       </p>
                                    </div>
                                 </div>
                                 <br>
...
<option class="itm<?php echo $customer_items['id'];?>" sell_prc="<?php echo $customer_items['net_sell_item_price'];?>" tax_code="<?php echo $customer_items['sell_item_tax_code'];?>" value="<?php echo $customer_items['id'];?>"><?php echo $customer_items['item_name'];?></option>
    ...
    <select class="form-control" id="tax_code" name="tax_code[]" readonly="">
    <option value="">Select</option>
    <?php
...
<option value="<?php echo $item_tax['tax_name'];?>"><?php echo $item_tax['tax_name'];?> @ <?php echo $item_tax['tax_rate']?>%</option>
    ...
    <div class="col-md-1">
    <input class="form-control" type="text" id="taxx1" name="tax[]" readonly></div>
    <input class="form-control" type="hidden" id="taxx_perc" name="tax_percentage[]">

    <div class="col-md-2"><input class="form-control" type="text" id="amount1" name="amount[]" readonly></div>
    <div class="col-md-1"></div>
    </div>
<br>
</div>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="row">'+
               ...
               '<div class="col-md-1">'+
               '<select  class="form-control" id="tax_code'+x+'" name="tax_code[]" readonly="">'+
               '<option value="">Select</option>'+
               ...
               '<div class="col-md-2"><input class="form-control" type="text" id="amount'+x+'" name="amount[]" readonly></div>'+
               '<a  href="#" id="remove_item'+x+'" class="remove_field_selling_estimate btn btn-default">x</a></div><br>'); //add input box
