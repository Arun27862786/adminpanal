...
<div class=" uk-grid "  >
                ...
                <h1 class="uk-heading-`line uk-text-center  text-white uk-margin-xlarge-top">Admin! Looks like you are lost</h1>
                <a  href="<?php echo $link->link('home',backend);?>"><h1 class="uk-heading-line uk-text-center  text-white uk-margin-xlarge-top">Go Back to home</h1></a>
