...
<hr>
    <div class="uk-margin">
        <button type="submit" class="uk-button uk-button-success uk-border-rounded uk-width-1-1@m" name="client_btn" ><span uk-icon="icon:plus-circle;"></span> Add Client </button> 
    </div>
