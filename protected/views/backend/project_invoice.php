...
<label class="uk-form-label" for="form-horizontal-text">Project Name</label> 
  ...
  <input class="uk-input" type="readonly" readonly  value="<?echo $pro['project_name'];?>" >
  </div> </div>

  <div class="uk-margin"> 
<label class="uk-form-label" for="form-horizontal-text">Client Name</label> 
    <div class="uk-form-controls">
 <input class="uk-input" type="readonly" readonly  value="<?echo $Client_name['name'];?>" >
  </div> </div> 
