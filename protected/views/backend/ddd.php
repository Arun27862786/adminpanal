...
<!-- <td><button type="button" class="uk-button-danger remove_field" id="remove_item<?php echo$x;?>"><span uk-icon="icon: close"></span> </button></td> -->
            </tr> <?php 
...
<hr> 
    ...
    <td class="line"><input type="hidden" id="discountf" name="discountf"><input class="form-control uk-text-right " type="text" id="discount" name="discount" value="<?php echo $get_invoice['discount'];?>"></td>
  </tr>
