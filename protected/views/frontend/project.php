   ...
   <hr class="uk-divider-icon">
    ...
    <table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
        ...
        if(is_array($project)){  
            ...
            $invoice_number=$db->get_row('invoices',array('project_id'=>$projects['id'])); 
             ?>    
           <tr>
                <td ><?php echo $sno++;?></td>
                <td><?php echo $projects['project_name'];?></td>                
                <td><?php echo $invoice_number['invoice_number'];?></td>   
                <td><?php echo $departs['name'];?></td>               
                <td><?php echo $projects['time_stamp'];?></td> 
                <td><?php echo $invoice_number['final_amount'];?></td>  
                <td><?php echo $invoice_number['due_amount'];?></td>                    
    ...
    <div class="uk-inline">
        ...
        <div uk-dropdown="mode: click; boundary: ! .uk-button-group; boundary-align: true; pos: left-center"> 
            <ul class="uk-nav uk-dropdown-nav ">  
             <li class="uk-nav-header"><a class="uk-text-success" href="<?php echo $link->link('view_project',frontend,'?view_id='.$projects['id']);?>" uk-icon="icon: file-edit">View Project</a></li>

              <!-- <li class="uk-nav-header"><a class="uk-text-success" href="<?php echo $link->link('add_invoices',frontend,'?project_id='.$projects['id']);?>" uk-icon="icon: folder">Invoices</a></li> -->
             <li class="uk-nav-header"><a class="uk-text-primary" href="<?php echo $link->link('project',frontend,'?archived_id='.$projects['id']);?>" onclick="return confirm('Are you sure to archived ')" uk-icon="icon: file-edit">archived Project</a></li>

             <li class="uk-nav-header"><a class="uk-text-danger" href="<?php echo $link->link('project',frontend,'?delete_id='.$projects['id']);?>" onclick="return confirm('Are you sure to Delete')" uk-icon="icon: trash">Delete Project</a></li>
            </ul>
        </div>
    </div>
</div></li>
        ...
        if(is_array($archived)){  
            ...
            $invoice_number1=$db->get_row('invoices',array('project_id'=>$project2['id']));
             ?>    
           <tr>
                <td ><?php echo $sno++;?></td>
                <td><?php echo $project2['project_name'];?></td>         
                <td><?php echo $invoice_number1['invoice_number'];?></td> 
                <td><?php echo $departs['name'];?></td>               
    ...
    <div class="uk-inline">
        ...
        <div uk-dropdown="mode: click; boundary: ! .uk-button-group; boundary-align: true; pos: left-center">
            <ul class="uk-nav uk-dropdown-nav">  
             <li class="uk-nav-header"><a class="uk-text-success" href="<?php echo $link->link('view_project',frontend,'?view_id='.$project2['id']);?>" uk-icon="icon: file-edit" >View Project</a></li>
             <li class="uk-nav-header"><a class="uk-text-primary" href="<?php echo $link->link('project',frontend,'?restore_id='.$project2['id']);?>"onclick="return confirm('Are you sure to Restore ')"uk-icon="icon: file-edit" >Restore Project</a></li>
             <li class="uk-nav-header"><a class="uk-text-danger"  href="<?php echo $link->link('project',frontend,'?delete_id='.$project2['id']);?>" onclick="return confirm('Are you sure to Delete')" uk-icon="icon: trash" >Delete Project</a></li>
            </ul>
        </div>
    </div>
</div></li>
        ...
        if(is_array($active)){  
            foreach ($active as $project4){
              ...
              $invoice_number2=$db->get_row('invoices',array('project_id'=>$project4['id'])); 
             ?>    
           <tr>
                <td ><?php echo $sno++;?></td>
                <td><?php echo $project4['project_name'];?></td>         
                <td><?php echo $invoice_number2['invoice_number'];?></td> 
                <td><?php echo $departs['name'];?></td>               
    ...
    <div class="uk-inline">
        ...
        <div uk-dropdown="mode: click; boundary: ! .uk-button-group; boundary-align: true; pos: left-center"> 
            <ul class="uk-nav uk-dropdown-nav">  
             <li class="uk-nav-header"><a class="uk-text-success" href="<?php echo $link->link('view_project',frontend,'?view_id='.$project4['id']);?>"uk-icon="icon: file-edit" >View Project</a></li>
             <li class="uk-nav-header"><a  class="uk-text-primary"href="<?php echo $link->link('project',frontend,'?archived_id='.$project4['id']);?>"onclick="return confirm('Are you sure to archived ')" uk-icon="icon: file-edit">archived Project</a></li>
             <li class="uk-nav-header"><a class="uk-text-danger"  href="<?php echo $link->link('project',frontend,'?delete_id='.$project4['id']);?>" onclick="return confirm('Are you sure to Delete')"  uk-icon="icon: trash">Delete Project</a></li>
            </ul>
        </div>
    </div>
</div></li>
...
window.location="<?php echo $link->link('project',frontend,'?status_v='); ?>"+st;
});
</script>