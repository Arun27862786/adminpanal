 ...
 <div uk-grid>
            <div class="uk-width-expand@m">
             <legend class="uk-legend">Add Ticket</legend>
      </div>
     <div class="uk-width-auto@m">
       <a  href="<?php echo $link->link('ticket',frontend);?>" class="uk-button uk-button-danger uk-border-rounded"><span uk-icon="icon: arrow-left"></span> Go Back </a>
     </div>
 </div> 
  <hr class="uk-divider-icon">
 <form class="uk-form-horizontal uk-margin-large" action="<?php $_SERVER['PHP_SELF'];?>" method="post" > 
