...
if(isset($_POST['add_answer'])){  
 ...
 $htmlcode = html($answer);
   if(empty($answer)) 
    ...
    $insert_answer = $db->insert('know_reply',array('knowledge_id'=>$get_data['id'],'user_id'=>$user_details['user_id'],'answer'=>$htmlcode,'create_date'=>time(),'ip_address'=>$_SERVER['REMOTE_ADDR']));
