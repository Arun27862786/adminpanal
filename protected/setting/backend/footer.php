...
//file upload
   ...
   var bar = document.getElementById('js-progressbar1');
    ...
    UIkit.upload('.js-upload1', {
        ...
        url: '<?php echo $link->link('ajax',backend,'&type=logo');?>',
    ...
    UIkit.upload('.js-upload2', {
        ...
        url: '<?php echo $link->link('ajax',backend,'&type=pdflogo');?>',
        multiple: false,
...
//profile image upload
    ...
    UIkit.upload('.js-upload-profile', {
        ...
        url: '<?php echo $link->link('ajax',backend,'&type=profile&id='.$_SESSION['user_id']);?>',
        multiple: false,
      ...
      if(name==""){
    	  ...
    	  UIkit.notification({
  	        ...
  	        $.ajax({
  	            ...
  	            url         : '<?php echo $link->link('ajax',backend);?>', // the url where we want to POST
...
table.row.add( {
        ...
        "3": phone,
        "4": address,
	    "5": '<ul class="uk-iconnav"><li><a href="<?php echo $link->link('clients',backend,'&id=');?>'+data+'" uk-icon="icon: file-edit"></a></li><li><a href="#" uk-icon="icon: trash"></a></li></ul>'    
